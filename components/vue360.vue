...
<script>
    ...
    export default {
        ...
        watch: {
            activeImg() {
                this.activeImage = this.activeImg;
                this.update();
            },
        ...
        methods: {
            ...
            play() {
                this.loopTimeoutId = window.setInterval(() => this.loopImages(), this.autoplaySpeed);
            },
            onSpin() {
            ...
            stop() {
                if (this.toImgActive) {
                    if (this.activeImage == this.toImg + 1) {

                        this.currentLoop = 0;
                        this.playing = false;
                        window.clearTimeout(this.loopTimeoutId);
                        this.$emit('changeActiveImg', this.activeImage);
                    }
                } else {
            ...
            loadInitialImage() {
                this.currentImage = this.imageData[this.activeImage];
                this.setImage()
            },
            resizeWindow() {
                this.setImage()
            ...
            bindPanModeEvents() {
                ...
                this.$refs.viewport.removeEventListener('mouseout', this.stopMoving);
                ...
                this.$refs.viewport.addEventListener('mouseout', this.stopDragging);
            },
            bind360ModeEvents() {
                ...
                this.$refs.viewport.removeEventListener('mouseout', this.stopDragging);
                ...
                this.$refs.viewport.addEventListener('mouseout', this.stopMoving);
            },
            togglePanMode() {
